    ...
    <div class="relative overflow-hidden bg-slate-800/90 backdrop-blur-md border border-slate-600 rounded-2xl shadow-2xl p-6 text-left group">
      ...
      <div class="relative z-10 mb-6 pr-24">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h2 class="text-2xl font-bold text-white">發現新版本</h2>
        </div>
        <div class="flex items-baseline gap-2">
          <span class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600">
            v{{ version }}
          </span>
          <span class="text-sm text-slate-400">已經準備好下載</span>
        </div>
      </div>
      ...
      <div class="relative z-10 flex gap-3 pt-2">
        ...
        <button 
          @click="handleConfirm"
          class="flex-1 px-4 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white rounded-xl font-bold shadow-lg shadow-green-500/25 transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
        >
          <span>🚀</span> 立即更新
        </button>
      </div>
